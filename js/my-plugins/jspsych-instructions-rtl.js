...
jsPsych.plugins['instructions-rtl'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-rtl',
    description: '',
    parameters: {
      pages: {
    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        //   var allowed = (current_page > 0 )? '' : "disabled='disabled'";
          nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn' style='margin-right: 5px;' >&lt; "+trial.button_label_next+"</button>";
        // }
        ...
        if (trial.allow_backward) {
          var allowed = (current_page > 0 )? '' : "disabled='disabled'";
          nav_html += "<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-left: 5px;' "+allowed+"> "+trial.button_label_previous+
              " &gt;</button></div>";
            }
